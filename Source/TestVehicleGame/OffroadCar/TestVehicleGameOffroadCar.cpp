...
#include "TestVehicleGameOffroadCar.h"
#include "TestVehicleGameOffroadWheelFront.h"
#include "TestVehicleGameOffroadWheelRear.h"
...
ATestVehicleGameOffroadCar::ATestVehicleGameOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UTestVehicleGameOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UTestVehicleGameOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UTestVehicleGameOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UTestVehicleGameOffroadWheelRear::StaticClass();
