...
#include "TestVehicleGameSportsCar.h"
#include "TestVehicleGameSportsWheelFront.h"
#include "TestVehicleGameSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

ATestVehicleGameSportsCar::ATestVehicleGameSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UTestVehicleGameSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UTestVehicleGameSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UTestVehicleGameSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UTestVehicleGameSportsWheelRear::StaticClass();
